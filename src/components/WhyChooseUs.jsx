...
const WhyChooseUs = () => {
  const images = [
    ...
    "https://media.istockphoto.com/id/1134576992/photo/teenager-girl-stock-images.jpg?s=612x612&w=0&k=20&c=YDg1e6DFYMnk3fz7Kr7K5A00-WyHvO_Qtje57zsbdds=",
  ...
  const images2 = [
    "https://media.istockphoto.com/id/1302216152/photo/indian-woman-greeting-students-in-front-of-mobile-during-virtual-online-class-at-home-concept.jpg?s=612x612&w=0&k=20&c=iaM82bLF4sZfxe0KrKI66YrT0CpwU5MfkrhN5l3yYT0=",
    ...
    "https://media.istockphoto.com/id/1250479244/photo/asian-boy-student-video-conference-e-learning-with-teacher-and-classmates-on-computer-in.jpg?s=612x612&w=0&k=20&c=I4ZCPv42AqVPMM536-QNkmfFYL0KBse5ybcPlX4CJYo=",
  ...
  return (
    <section className="bg-white py-4 md:py-2 flex justify-between items-start w-full px-8 gap-6 flex-wrap lg:flex-nowrap overflow-hidden">
...
Founded by a team of passionate entrepreneurs, Refer Me Group was born out of the need to create a smarter, more effective pathway for professionals to upskill. Our programs are led by seasoned industry experts who bring real-world knowledge into every session — inspiring learners to meet career challenges with confidence.
      ...
      <div className="w-full lg:w-[45%] flex justify-center items-center gap-2">
