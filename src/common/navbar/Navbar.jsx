          ...
          <div className="flex justify-between items-center py-3">
            <div className="flex items-center gap-1">
              ...
              <nav className="flex ml-6 gap-1" role="navigation">
                ...
                <NavLink href="#" aria-label="Jobs">
                  Jobs
                </NavLink>
                <NavLink href="#" aria-label="Our Blogs">
                  Our Blogs
                </NavLink>
                <NavLink href="/career" aria-label="Careers">
                  Careers
                </NavLink>
                <NavLink href="/contact" aria-label="Contact Us">
                  Contact Us
                </NavLink>
              </nav>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <SocialIcon
                icon={<FaInstagram />}
                bg="bg-gradient-to-tr from-pink-600 to-amber-500"
      ...
      >
        ...
        <div className="overflow-y-scroll h-[calc(100%-100px)]">
          <nav className="flex flex-col py-2" role="navigation">
            <MobileNavLink href="/" aria-label="Home">
              Home
            </MobileNavLink>
            ...
            <MobileNavLink href="#" aria-label="Jobs">
              Jobs
            </MobileNavLink>
            <MobileNavLink href="#" aria-label="Our Blogs">
              Our Blogs
            </MobileNavLink>
            <MobileNavLink href="#" aria-label="Careers">
              Careers
            </MobileNavLink>
            <MobileNavLink href="#" aria-label="Contact Us">
              Contact Us
            </MobileNavLink>
          </nav>
        </div>
