  ...
  const jobListings = [
    {
      ...
      description:
        "Bridge the gap between business needs and technical solutions, driving efficiency and innovation.",
      responsibilities: [
      ...
      applyLink:
        "mailto:careers@refermegroup.com?subject=Application%20for%20Business%20Analyst",
    },
    {
      title: "Developer (DEV)",
      description:
        "Build cutting-edge applications and platforms to empower our clients and users.",
      responsibilities: [
      ...
      applyLink:
        "mailto:careers@refermegroup.com?subject=Application%20for%20Developer",
    },
    {
      title: "Human Resources (HR)",
      description:
        "Foster a positive workplace culture and support our team’s growth and development.",
      responsibilities: [
      ...
      applyLink:
        "mailto:careers@refermegroup.com?subject=Application%20for%20Human%20Resources",
    },
    {
      title: "Manager",
      description:
        "Lead teams to deliver projects on time and exceed client expectations.",
      responsibilities: [
      ...
      applyLink:
        "mailto:careers@refermegroup.com?subject=Application%20for%20Manager",
    },
    {
      title: "Quality Assurance (QA)",
      description:
        "Ensure our products meet the highest standards of quality and reliability.",
      responsibilities: [
      ...
      applyLink:
        "mailto:careers@refermegroup.com?subject=Application%20for%20Quality%20Assurance",
    },
    {
      title: "Social Media (SM)",
      description:
        "Amplify our brand and engage our audience through creative social media strategies.",
      responsibilities: [
      ...
      applyLink:
        "mailto:careers@refermegroup.com?subject=Application%20for%20Social%20Media",
    },
  ];
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <section className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
              At ReferMeGroup, we’re passionate about innovation and growth.
          ...
          <section className="bg-white p-8 rounded-lg shadow-md mb-12">
            ...
            <p className="text-gray-600 text-center max-w-3xl mx-auto mb-6">
              Interested in joining us? Click the "Apply Now" button for the
              role you’re interested in and send your resume and cover letter to{" "}
              <a
              ...
              . Please include the job title in the subject line. We’ll review
          ...
          <section className="text-center">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-8">
              At ReferMeGroup, we foster a culture of innovation, collaboration,
              and continuous learning. Our team enjoys flexible work
              arrangements, professional development opportunities, and a
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 text-sm">
                  Access training and mentorship to advance your career and
                  skills.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 text-sm">
                  Collaborate with a diverse, passionate team to achieve shared
                  goals.
                </p>
              </div>
            </div>
